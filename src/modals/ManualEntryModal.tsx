    ...
    <div className="w-full flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-5">
        <div className="flex justify-end">
          <button className="text-primary hover:text-blue-500 text-sm font-bold flex items-center gap-1 transition-colors group">
            <span className="material-symbols-outlined text-base group-hover:scale-110 transition-transform">visibility</span>
            查看原图
          </button>
        </div>
      ...
      <div className="p-4 border-t border-slate-100 dark:border-[#233648] bg-white dark:bg-[#16212b]">
        <div className="grid grid-cols-2 gap-4">
          ...
          <button onClick={handleSubmit} className="h-12 rounded-lg bg-primary text-white font-bold shadow-lg shadow-primary/30 hover:bg-blue-600 active:scale-[0.98] transition-all focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-[#16212b]">
            确认补录
          </button>
        </div>
      </div>
